...
import com.example.common.api.GlobalControllerAdvice;
...
class ArticleControllerTestV2 {
    ...
    void setUp() {
        ...
        updateArticleUseCase = Mockito.mock(UpdateArticleUseCase.class);
        deleteArticleUseCase = Mockito.mock(DeleteArticleUseCase.class);
        queryArticleUseCase = Mockito.mock(QueryArticleUseCase.class);
        ...
        mockMvc = MockMvcBuilders
                .standaloneSetup(new ArticleController(createArticleUseCase, updateArticleUseCase, deleteArticleUseCase, queryArticleUseCase))
                .alwaysDo(print())
